...
source url: "http://shain-bucket.s3.amazonaws.com/fipscanister.lib"

relative_path "fipscanister.lib"
...
build do
  ...
  copy "#{project_dir}/fipscanister.lib", "#{install_dir}/embedded/lib"
